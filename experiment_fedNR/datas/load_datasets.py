...
def load_mimic(base_dir: str = './datas'):
    ...
    # datay = datas['day_28_flg'].values
    # datay = (datas['hospital_los_day']>6).values
    # datay = datas['hosp_exp_flg'].values
...
def load_celldiff(base_dir='./datas'):
...
def load_mnist2(base_dir='./datas'):
...
def add_noise(src_dataset, noise_type, noise_ratio, noise_degree):
    ...
    if noise_type == 'feature':
        ...
        # Set the probability of choosing noise or original y datas with the possibility of noise_degree
