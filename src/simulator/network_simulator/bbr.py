...
class RateSample:
    def __init__(self):
        ...
        self.interval = 0.0
        # The amount of datas marked as delivered over the sampling interval.
        self.delivered = 0
...
class ConnectionState:
    def __init__(self):
        ...
        # The total amount of datas (tracked in octets or in packets) delivered
        ...
        # The datas sequence number one higher than that of the last octet
...
class BBRSender(Sender):
    ...
    def handle_probe_rtt(self):
        ...
        packets_in_flight = self.bytes_in_flight / BYTES_PER_PACKET
        self.app_limited = False  # assume always have available datas to send from app
