...
# datas = PantheonDataset('../../datas', 'all')
# datas.dump_dataset('../../datas/converted_pantheon')
# data_feature, data_attribute, data_gen_flag = datas.prepare_data_for_DoppelGANger(500)
# np.savez('/tank/zxxia/DoppelGANger/datas/pantheon/data_train.npz',
#          data_feature=data_feature, data_attribute=data_attribute,
#          data_gen_flag=data_gen_flag)
# np.savez('/tank/zxxia/DoppelGANger/datas/pantheon/data_train_no_attribute.npz',
#          data_feature=data_feature, data_attribute=data_attribute,
#          data_gen_flag=data_gen_flag)
