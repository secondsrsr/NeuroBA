...
VIDEO_SIZE_FILE_DIR = '/data3/zxxia/pensieve/datas/video_sizes'
...
TEST_TRACE_DIR = '/data3/zxxia/pensieve/datas/test'
VAL_TRACE_DIR = '/data3/zxxia/pensieve/datas/val'
TRAIN_TRACE_DIR = '/data3/zxxia/pensieve/datas/train'
