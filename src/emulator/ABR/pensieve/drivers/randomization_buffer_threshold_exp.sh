...
if [ $(hostname) = "farewell" ]; then
    ...
    echo "in loon"
    # VIDEO_SIZE_FILE_DIR='./pensieve/datas/video_size_6_larger'
    ...
    # TRAIN_TRACE_DIR=./pensieve/datas/synthetic_traces/train_buf_cap_smart_train
    val_trace_dir=pensieve/data/synthetic_traces/val_rand_max_throughput
    # TEST_TRACE_DIR=./pensieve/datas/synthetic_traces/test_buf_cap_smart_train
